...
// root needed        "smaps_rollup/=Swap:/2", "Swap",
        "status/=/1/VmSwap:/2", "Swap",
        ProcStatType::MemQtyKb,
    ),
    Stat::new(
        "memory.stat/=/1/anon/2", "Anonymous", 
        "Amount of memory used in anonymous mappings.", 
        StatType::MemQtyCumul,
// root needed        "smaps_rollup/=Anonymous:/2", "Anonymous",
        "status/=/1/RssAnon:/2", "Anonymous",
        ProcStatType::MemQtyKb,
    ),
    Stat::new(
        "memory.stat/=/1/file/2", "File Cache", 
    ...
    Stat::new(
        "memory.stat/=/1/kernel_stack/2", "Kernel Stack", 
    ...
    Stat::new(
        "memory.stat/=/1/pagetables/2", "Page Table", 
        "Amount of memory used for page tables.", 
        StatType::MemQtyCumul,
        "status/=/1/VmPTE:/2", "VM PTE",
        ProcStatType::MemQtyKb,
    ),
    Stat::new(
        "memory.stat/=/1/percpu/2", "Per CPU", 
    ...
    Stat::new(
        "memory.stat/=/1/file_dirty/2", "File Dirty", 
    ...
    Stat::new(
        "memory.stat/=/1/file_writeback/2", "File Writeback", 
    ...
    Stat::new(
        "memory.stat/=/1/swapcached/2", "Swap Cached", 
    ...
    Stat::new(
        "memory.stat/=/1/unevictable/2", "Unevictable", 
        "Amount of unevictable memory.", 
        StatType::MemQtyCumul,
        "status/=/1/VmPin:/2", "VM Pin",
        ProcStatType::MemQtyKb,
    ),
    Stat::new(
        "memory.stat/=/1/slab/2", "Slab", 
