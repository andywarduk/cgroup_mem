...
// root needed        "smaps_rollup/=Anonymous:/2", "Anonymous",
    ...
    Stat::new(
        "memory.stat/=kernel_stack/2", "Kernel Stack", 
    ...
    Stat::new(
        "memory.stat/=pagetables/2", "Page Table", 
        "Amount of memory used for page tables.", 
        StatType::MemQtyCumul,
        "status/=VmPTE:/2", "VM PTE",
        ProcStatType::MemQtyKb,
    ),
    Stat::new(
        "memory.stat/=percpu/2", "Per CPU", 
    ...
    Stat::new(
        "memory.stat/=shmem/2", "Swap Backed", 
    ...
    Stat::new(
        "memory.stat/=file_mapped/2", "File Mapped", 
        "Amount of cached filesystem data mapped.", 
        StatType::MemQtyCumul,
        "status/=RssFile/2", "RSS File",
        ProcStatType::MemQtyKb,
    ),
    Stat::new(
        "memory.stat/=file_dirty/2", "File Dirty", 
    ...
    Stat::new(
        "memory.stat/=file_writeback/2", "File Writeback", 
    ...
    Stat::new(
        "memory.stat/=swapcached/2", "Swap Cached", 
    ...
    Stat::new(
        "memory.stat/=unevictable/2", "Unevictable", 
        "Amount of unevictable memory.", 
        StatType::MemQtyCumul,
        "status/=VmPin:/2", "VM Pin",
        ProcStatType::MemQtyKb,
    ),
    Stat::new(
        "memory.stat/=slab/2", "Slab", 
